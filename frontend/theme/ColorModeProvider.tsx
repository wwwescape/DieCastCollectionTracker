...
const MODE_STORAGE_KEY = "dct.colorMode";
const CONTRAST_STORAGE_KEY = "dct.contrast";
...
export const ColorModeProvider = ({ children }: { children: ReactNode }) => {
  ...
  // Stored choice always wins over OS preference once the user has made one. OS
  // preference is only the seed for the very first visit.
