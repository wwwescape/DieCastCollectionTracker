...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "DieCastCollectionTracker",
        short_name: "DCT",
        description: "Track and organize your die-cast car collection.",
        theme_color: "#E10600",
      ...
      workbox: {
        ...
        // app-data layer. Workbox only needs to handle what TanStack Query can't: the
        // app shell assets (JS/CSS/HTML) which it already caches via precaching.
        runtimeCaching: [
          {
            urlPattern: /^\/uploads\/.*/,
            handler: "CacheFirst",
            options: {
              cacheName: "car-photos",
